    ...
    public class InsertHouseholdExpenses : Migration
    {
        public override void Up()
        {
            ...
            Insert.IntoTable("HouseholdExpense")
                ...
                .Row(new { Description = "Computer Shop 4", UserId = 4, Value = 1000, Date = new DateTime(now.Year, now.AddMonths(-1).Month, 3), Type = 10, CreditCardId = 7 })
                .Row(new { Description = "Computer Shop 5", UserId = 4, Value = 1000, Date = new DateTime(now.Year, now.AddMonths(-1).Month, 4), Type = 10, CreditCardId = 7 })
                .Row(new { Description = "Computer Shop 5", UserId = 4, Value = 1000, Date = new DateTime(now.Year, now.AddMonths(-1).Month, 5), Type = 10, CreditCardId = 7 });
        }
